...
a. Go to [github.com](https://github.com/) and log in (you need your own account - for now use your uea.ac.uk e-mail)

b. In the Search bar, look for repo **Philip-Leftwich/5023Y-Happy-Git**

c. Click on the repo name, and look out the existing repo structure
...
g. Attach the {tidyverse},{palmerpenguins}, {DT}, and {plotly} packages in a hidden code chunk (include = FALSE)
...
knitr::include_graphics("disease_graph.png")
```
